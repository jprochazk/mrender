 ...
 * A 3x3 matrix.
 *
 * Stored in column-major layout, which means that
...
export class Matrix3 extends Array<number> {
  ...
  frob(): number {
    return fhypot(this[0], this[1], this[2], this[3], this[4], this[5], this[6], this[7], this[8]);
  }
  ...
  static translated(value: ReadonlyVector2): Matrix3 {
    return new Matrix3(1, 0, 0, 0, 1, 0, value[0], value[1], 1);
  }
  ...
  static scaled(value: ReadonlyVector2): Matrix3 {
    return new Matrix3(value[0], 0, 0, 0, value[1], 0, 0, 0, 1);
  }
