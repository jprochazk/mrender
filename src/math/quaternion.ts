...
export class Quaternion extends Array<number> {
     ...
     */
    static fromAxes(view: ReadonlyVector3, right: ReadonlyVector3, up: ReadonlyVector3): Quaternion {
...
export function quat(x: number = 0, y: number = 0, z: number = 0, w: number = 1): Quaternion {
