...
export class Vector3 extends Array<number> {
    ...
    transformM4(mat: Matrix4): this {
        ...
        if (w === 0.0) w = 1.0;
        this[0] = (mat[0] * this[0] + mat[4] * this[1] + mat[8] * this[2] + mat[12]) / w;
        this[1] = (mat[1] * this[0] + mat[5] * this[1] + mat[9] * this[2] + mat[13]) / w;
        this[2] = (mat[2] * this[0] + mat[6] * this[1] + mat[10] * this[2] + mat[14]) / w;
        return this;
    }
    /**
