...
type OffsetInfo = { offset: number; attributes: Attribute[] };

export class AttributeArrayBuilder {
  private indexSequence: number = 0;
  private attributes: Attribute[] = [];
  private offsets: Record<number, OffsetInfo> = {};
  private indexBuffer?: Buffer<TypedArray>;

  constructor(private id: number, private gl: WebGL2RenderingContext) {}
